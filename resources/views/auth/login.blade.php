...
<body>
                            ...
                            <div class="cls-content">
                                <div class="panel cls-content-sm ">
                                    <div class="panel-body">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="checkbox pad-btm text-left">
                                                ...
                                                <label for="demo-form-checkbox">Recordamer</label>
                                            </div>
                                            <button class="btn btn-primary btn-lg btn-block" type="submit">Inicar
                                                Sesion</button>
                                    ...
                                    <div class="pad-all">
                                        ...
                                        <a class="btn-link mar-rgt" href="{{ route('register') }}">
                                            ¿Registrarse?
                                        </a>
                                        @endif
    ...
    <script src="{{asset('../resources/js/demo/tables-datatables.js')}}"></script>
    ...
    <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"
        ...
        crossorigin=""></script>
    <script src="{{asset('../resources/js/Mapa.js')}}"></script>
    <!--Specify page [ SAMPLE ]-->
